		...
		$(".owl-carousel").each(function () {
			...
			$(this)
				...
				.each(function (index) {
					...
					$(this).attr("aria-label", `icon ${index + 1}`);
				});
		});
...
function init_wow() {
	(function ($) {
		...
		if ($("body").hasClass("appear-animate")) {
			$(".wow").addClass("animate__no-animate");
		}
		var wow = new WOW({
			boxClass: "wow",
			animateClass: "animate__animated",
		...
		if ($("body").hasClass("appear-animate")) {
			$(".wow-p").addClass("animate__no-animate");
			var wow_p = new WOW({
				boxClass: "wow-p",
				animateClass: "animate__animated",
				offset: 100,
		...
		if (
			...
			$(".wow-menubar")
				.addClass("animate__no-animate")
				.addClass("animate__fadeInDown")
				.addClass("animate__animated");
			setInterval(function () {
				$(".wow-menubar").removeClass("animate__no-animate");
			}, 1500);
		} else {

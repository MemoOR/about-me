...
create-cert:
	@docker compose run --rm certbot /bin/bash -c "rm -r /etc/letsencrypt/live; certbot certonly --webroot --webroot-path /var/www/certbot/ -d guillermoortega.me -n -m memo.or99@hotmail.com --agree-tos"

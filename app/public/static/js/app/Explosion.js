import {
	...
	Mesh,
	ShaderChunk,
} from "/static/js/libs/Threejs/three.module.js";
import { noise } from "/static/js/libs/Noise.js";
import { Tween } from "/static/js/libs/Toon3D.js";
		...
		this.uniforms = {
			...
			u_tex: {
				value: new TextureLoader().load(
					`${this.obstacles.assetsPath}models/plane/explosion.png`
				),
			},
		};
